...
const SHARED = {
  ...
  ko: {
    ...
    voyageTitle: '항해도',
    voyageIntro:
      '프로젝트 다섯 개를 한 지도에 올렸습니다. 점선은 오래된 것부터 최신 순서입니다. 항로를 따라가면 GHCR까지 간 IoTBay CI/CD 줄도 보입니다.',
    ...
    timelineFoundations:
      'Programming, DB, Networks, Web Systems는 면제로 이미 채워져 있었습니다. 1주차부터가 아니라 중간에서 시작했습니다.',
    semesterSpr24Title: 'Cloud & Architecture',
    semesterSpr24Body:
    ...
    semesterSpr25Body:
      'Adv Soft Dev 87점 HD(A+ 상당) 결과물이 le-restaurant입니다. 5인 팀, Spring Boot + React, Azure 배포. Interaction Design, Interactive Media, Project Management가 같은 학기에 있었습니다.',
...
export const STRINGS: Record<Lang, Strings> = {
  ...
  ko: {
    ...
    skillsIntro: '아래 항목은 제가 만든 프로젝트나 성적표와 연결되어 있습니다.',
